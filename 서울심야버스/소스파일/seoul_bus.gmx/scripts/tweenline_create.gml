...
_tl[TLTWEEN.ID] = ++global._tw_id;                  // ID
_tl[TLTWEEN.INRENDERLIST] = true;                   // If false, this tweenline it's not in the rendering list. (but it exists)
...
_tl[TLTIMELINE.LASTTWEEN] = undefined;              // Time of the last edited tween 
ds_list_add(global._tw_tl_dslist, _tl);             // Add the tweenline to the list of tweenlines


global._tw_current_creation_tl = _tl;               // Set the edit mode to the current tweenline
