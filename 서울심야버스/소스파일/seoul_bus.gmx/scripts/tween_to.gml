...
/*
    ...
    target_object [Game Maker Object]
        ...
        You can also pass an array of objects or instances. In wich case, an array of tweens is 
...
var target = instance_select_array(argument0);
if (array_length_1d(target) > 1) { 
    return tween_stagger_to(argument0,argument1,argument2,0);
}
var _t = __tl_private_new_tween(target[0], argument1);
