/* 
    ...
    Q: HOW to USE a different easing:
    A: Pass some ease_ script to the "ease" VAR when you are creating your tween:
...
================== ease_back (in/out/inout) modifiers: ==================
    ...
    tween_set_modifiers(tween_index, array(overshot));
...
================== ease_pow (in/out/inout) modifiers: ==================
    ...
    tween_set_modifiers(tween_index, array(power));
